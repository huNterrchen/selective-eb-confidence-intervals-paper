...
import JuMP: @constraint, @variable, set_lower_bound, @expression,
    ...
    set_normalized_rhs, RotatedSecondOrderCone, SecondOrderCone, set_value, termination_status
...
export EBayesSample,
    ...
    PosteriorMean,
    PosteriorVariance,
    SignAgreementProbability,
    CoverageProbability,
    ConditionalReplicationProbability,
    FutureCoverageProbability,
    ReplicationDominantProbability,
    MarginalDensity,
    MarginalDistribution,
    ExtendedMarginalDensity_without,
    PriorDensity,
    DiscretePriorClass,
    MixturePriorClass,
