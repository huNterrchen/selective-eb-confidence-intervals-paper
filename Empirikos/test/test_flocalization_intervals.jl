...
gauss_loc_02 =
    InfinityNormDensityBand(; a_min = -3.0, a_max = 3.0, α = 0.2, rng = StableRNG(100))
...
confint1_prefitted_convexvexity =
    confint(floc_interval_prefitted, target1, Zs_standard, Empirikos.ConvexVexity())
...
gauss_loc_01 =
    InfinityNormDensityBand(; a_min = -3.0, a_max = 3.0, α = 0.1, rng = StableRNG(100))
