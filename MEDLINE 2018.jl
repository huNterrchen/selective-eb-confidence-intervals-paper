...
tbl = CSV.File("medline_2018_random.csv")
zs = tbl.z
pgfplotsx()
...
savefig("z_dist_medline_2018.png")
...
ci_marginal_cdf_196_pretilt = confint(floc_dkw, marginal_cdf_196_pretilt)
...
#97.5%
dkw_975= DvoretzkyKieferWolfowitz(α = 0.025,  max_constraints = Inf)
...
frac_published_above_196_left = frac_published_above_196 - 1.96 * _se
frac_published_above_196_right = frac_published_above_196 + 1.96 * _se
...
#with Locationscale prior
marginal_cdf_196_pretilt = Empirikos.untilt(Empirikos.MarginalDensity(FoldedNormalSample(Interval(0.0, 1.96), 1.0)))
ci_ls_marginal_cdf_196_pretilt = confint(floc_locationscale_dkw, marginal_cdf_196_pretilt)
...
savefig("marginal_density_normalized_plot_2018.pdf")
...
savefig("marginal_density_unnormalized_plot_2018.pdf")
...
savefig("same_sign_prob_plot_2018.pdf")
...
savefig("coverage_prob_plot_2018.pdf")
...
savefig("repl_prob_plot_2018.pdf")
...
savefig("future_coverage_prob_plot_2018.pdf")
...
savefig("replication_dominant_prob_plot_2018.pdf")
...
savefig("posterior_mean_plot_2018.pdf")
...
savefig("power_probability_plot_2018.pdf")



pow_80_target = Empirikos.untilt(StandardNormalPowerDistribution(0.80))
