...
The data we used in our paper is adapted from [Barnett and Wren [2019]](https://bmjopen.bmj.com/content/9/11/e032506); their original data is generated and contained in the **Archive** folder. On top of that, we processed the data further in **Data Processing.R**.
